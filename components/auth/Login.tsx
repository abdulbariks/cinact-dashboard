...
const normalizeClientRole = (
  role?: string,
): "admin" | "tutor" | "finance" | "viewer" => {
  if (!role) return "viewer";

  const currentRole = role.toLowerCase().trim();
  if (
    currentRole === "su_admin" ||
    currentRole === "admin" ||
...
const getRedirectPath = (
  role: "admin" | "tutor" | "finance" | "viewer",
): string => {
      ...
      <div className="hidden lg:block lg:w-2/5 bg-[#0c1015] relative overflow-hidden">
        <div className="relative w-full h-full">
          ...
          <div className="absolute  top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white ">
            ...
            <p className="text-[#8C9196] text-center">
              Manage classes, students, and faculty in one <br /> secure
              dashboard.
            </p>
          </div>
        </div>
      ...
      <div className="w-full lg:w-3/5 flex items-center justify-center bg-black min-h-screen p-4">
        <div className="bg-[#0a1726] p-[30px] rounded-[16px] w-full max-w-[503px] shadow-xl">
          ...
          <div className="  mb-8">
            ...
            <h1 className="text-2xl font-medium text-white mt-4">
