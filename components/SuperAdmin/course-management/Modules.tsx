...
export default function Modules() {
    ...
    return (
        <div  >
            ...
            >
                <AccordionItem value="module-1" className="border border-[#3D4566] rounded-[16px] [&_[data-slot=accordion-trigger]>svg]:hidden">
                    <AccordionTrigger className="flex items-center justify-between text-left text-white hover:no-underline cursor-pointer    px-4 data-[state=open]:bg-[#262b40] rounded-t-[16px] rounded-b-none  ">
                ...
                <AccordionItem value="module-2" className="border border-[#3D4566] rounded-[16px] [&_[data-slot=accordion-trigger]>svg]:hidden">
                    <AccordionTrigger className="flex items-center justify-between text-left text-white hover:no-underline cursor-pointer px-4 data-[state=open]:bg-[#262b40] rounded-t-[16px] rounded-b-none">
                        <div className="flex flex-col gap-1">
                ...
                <AccordionItem value="module-3" className="border border-[#3D4566] rounded-[16px] [&_[data-slot=accordion-trigger]>svg]:hidden">
                    <AccordionTrigger className="flex items-center justify-between text-left text-white hover:no-underline cursor-pointer px-4 data-[state=open]:bg-[#262b40] rounded-t-[16px] rounded-b-none">
                        <div className="flex flex-col gap-1">
