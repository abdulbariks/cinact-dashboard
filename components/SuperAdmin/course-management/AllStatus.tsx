...
export function AllStatus({ value, onValueChange }: AllStatusProps) {
  return (
    <Select name="status" value={value} onValueChange={onValueChange}>
      ...
      <SelectContent className="border-none bg-[#0a1929] text-[#777980] **:data-[slot=select-item]:text-[#777980] [&_[data-slot=select-item][data-highlighted]]:bg-[#5f6ca0] [&_[data-slot=select-item][data-highlighted]]:text-white [&_[data-slot=select-item][data-state=checked]]:text-white">
        <SelectGroup>
