  ...
  return (
    <div>
      <div className='flex items-center gap-2'>
        <Link href='/dashboard/course-management' className='text-base text-[#5F6CA0] hover:text-[#8D9CDC]'>
          Course Management
        </Link>
      ...
      <div className=' mt-6'>
      <h2 className=' text-2xl text-[#E6E7E8] font-semibold'>Course Details</h2>
      <div className=' bg-[#0a1929] p-4 rounded-2xl mt-5'>
        <div className=' bg-[#07121d] p-4 rounded-[10px]'>
          <div className=' flex items-center justify-between'>
          <h3 className=' text-xl text-white font-medium'>1 year program ( adult)</h3>
