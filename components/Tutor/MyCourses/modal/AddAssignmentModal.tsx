  ...
  return (
    <Dialog>
      ...
      <DialogTrigger asChild>
        <button className="flex items-center justify-center gap-2 border-2 border-dashed border-[#1E2638] rounded-[12px] p-5 min-h-28 text-[#A1AAB3] hover:text-white hover:border-[#3E4766] transition-all w-full cursor-pointer">
