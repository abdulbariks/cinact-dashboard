...
export default function VideoIcon(props: React.SVGProps<SVGSVGElement>) {
  ...
  <path d="M11.5 11C12.3284 11 13 10.3284 13 9.5C13 8.67157 12.3284 8 11.5 8C10.6716 8 10 8.67157 10 9.5C10 10.3284 10.6716 11 11.5 11Z" stroke="white" stroke-width="1.5"/>
</svg>
  )
}
